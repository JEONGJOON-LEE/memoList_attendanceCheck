...
<!-- 삭제할 글이 테이블에 존재하므로 삭제할 글을 화면에 보여주고 비밀번호를 입력받는다. -->				
	<form action="deleteOK.jsp" method="post">
		...
		<!-- 삭제할 글 번호와 삭제 후 돌아갈 페이지 번호도 deleteOK.jsp로 넘겨줘야 한다. -->
...
//			삭제할 글 번호와 돌아갈 페이지 번호가 숫자가 아님으로 에러 메시지를 출력하고 memoList4.jsp로 보낸다.	
			out.println("<script>");
...
//		삭제할 글 번호와 돌아갈 페이지 번호가 모두 넘어오지 않았으므로 에러 메시지를 출력하고 memoList4.jsp로 보낸다.	
		out.println("<script>");
